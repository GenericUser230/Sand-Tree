addLayer("r", {
    ...
    symbol: "Rocks", // This appears on the layer's node. Default is the id with the first letter capitalized
    ...
    baseResource: "sand", // Name of resource prestige is based on
    baseAmount() {return player.points}, // Get the current amount of baseResource
    type: "normal", // normal: cost to gain currency depends on amount gained. static: cost depends on how much you already have
    exponent: 0.67, // Prestige currency exponent
